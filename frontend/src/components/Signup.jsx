...
const Signup = () => {
    ...
    const signupHandler = async (e) => {
        ...
        try {
            ...
            const flaskResponse = await axios.post("http://127.0.0.1:5000/encode", { image_url: imageUrl });
    ...
    return (
        <div className='flex flex-col items-center w-screen h-screen justify-center'>
            <form onSubmit={signupHandler} className='shadow-lg flex flex-col gap-5 p-8 py-10 max-w-lg w-full'>
                ...
                <p className='text-center'>Upload an image or capture a photo.</p>
                ...
                <div className='flex flex-col items-center'>
                    {imagePreview ? (
                        <img src={imagePreview} alt="Selected" className="w-full max-h-64 object-cover border rounded-md mb-2" />
                    ) : useCamera && (
                    ...
                    <button type='button' onClick={() => { setUseCamera(true); startCamera(); }} className='mt-3 bg-blue-600 text-white px-4 py-2 rounded-md'>Use Camera</button>
